...
function sendEveryoneEveryday () {
  ...
  for (var i=1; i<=nRecipients; i++) {
    ...
    var body
                  ...
                  + 'https://docs.google.com/forms/d/e/報告フォームのID/viewform?entry.353144605='+studentno+'&entry.1785790273='+part+'&entry.1921967697='+name+'&entry.153496026='+mailto+'&entry.1353047343_year='+todayYear+'&entry.1353047343_month='+todayMonth+'&entry.1353047343_day='+todayDate+'\n\n'
